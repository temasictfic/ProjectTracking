package com.tobeto.project_tracking.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.tobeto.project_tracking.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.tobeto.project_tracking.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
describe('Project e2e test', () => {
  ...
  const projectSample = { name: 'conspire drat', startDate: '2024-07-09', endDate: '2024-07-09' };
  ...
  describe('new Project page', () => {
    ...
    it('should create an instance of Project', () => {
      cy.get(`[data-cy="name"]`).type('psst zowie');
      cy.get(`[data-cy="name"]`).should('have.value', 'psst zowie');

      cy.get(`[data-cy="startDate"]`).type('2024-07-09');
      cy.get(`[data-cy="startDate"]`).blur();
      cy.get(`[data-cy="startDate"]`).should('have.value', '2024-07-09');

      cy.get(`[data-cy="endDate"]`).type('2024-07-09');
      cy.get(`[data-cy="endDate"]`).blur();
      cy.get(`[data-cy="endDate"]`).should('have.value', '2024-07-09');
